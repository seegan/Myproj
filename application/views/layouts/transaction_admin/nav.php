...
<div id="nav-wrapper">
    <ul id="nav"
        ...
        <li><a href="<?php echo base_url();?>reipients_manage/createrecipients"> <i class="fa fa-home"><span class="icon-bg bg-info"></span></i><span data-i18n="Create Recipients"></span></a></li>
        <li><a href="<?php echo base_url();?>reipients_manage/managerecipients/manage"> <i class="fa fa-home"><span class="icon-bg bg-info"></span></i><span data-i18n="Manage Recipients"></span></a></li>
        <li>
