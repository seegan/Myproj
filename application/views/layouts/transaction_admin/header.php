                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <a href="javascript:;" class="media">
                                ...
                                <div class="media-body">
                                    <span class="block">ram sent you a message</span>
                        ...
                        <li class="list-group-item">
                            <a href="javascript:;" class="media">
                                ...
                                <div class="media-body">
                                    <span class="block">Kumar sent you a mail</span>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <a href="javascript:;" class="media">
                                ...
                                <div class="media-body">
                                    <span class="block">suji sent you a mail</span>
                        ...
                        <li class="list-group-item">
                            <a href="javascript:;" class="media">
                                ...
                                <div class="media-body">
                                    <span class="block">Honey sent you a mail</span>
                                    <span class="text-muted">3 hours ago</span>
                                </div>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a href="javascript:;" class="media">
                                ...
                                <div class="media-body">
                                    <span class="block">shoe sent you a mail</span>
...
<!--             <li class="dropdown">
            ...
            <li class="dropdown text-normal nav-profile">
                ...
                <ul class="dropdown-menu with-arrow pull-right">
                    ...
                    <li>
                        <a href="<?php echo base_url('client/client_home/logout');?>">
